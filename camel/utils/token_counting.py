...
def messages_to_prompt(messages: List[OpenAIMessage], model: ModelType) -> str:
    ...
    ret: str
    if model == ModelType.LLAMA_2_7b or model == ModelType.LLAMA_2_13b or model == ModelType.LLAMA_2_70b:
        ...
        for i, msg in enumerate(messages[1:]):
            ...
            if message:
                ...
                ret += role
        return ret
    elif model == ModelType.VICUNA_7b or model == ModelType.VICUNA_16K or model == ModelType.VICUNA_13b or model == ModelType.VICUNA_33b:
        seps = [" ", "</s>"]
